...
import (
	...
	"github.com/BabyJhon/skillsrock-test-task/configs"
	"github.com/BabyJhon/skillsrock-test-task/internal/handlers"
	"github.com/BabyJhon/skillsrock-test-task/internal/repository"
	"github.com/BabyJhon/skillsrock-test-task/internal/service"
	"github.com/BabyJhon/skillsrock-test-task/pkg/postgres"
...
func Run() {
	...
	logrus.Print("8")
	logrus.Print("SkillsRock test task API started")
	...
	logrus.Println("Сервер грациозно остановлен")
